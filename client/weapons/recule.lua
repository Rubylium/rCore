local recoils = {
	...
	[GetHashKey("weapon_carbinerifle")] = 1.2, -- REMOTE SNIPER
	[GetHashKey("weapon_carbinerifle")] = 1.0, -- GRENADE LAUNCHER
	[GetHashKey("weapon_carbinerifle")] = 1.0, -- GRENADE LAUNCHER SMOKE
	[GetHashKey("weapon_carbinerifle")] = 0.0, -- RPG
	[GetHashKey("weapon_carbinerifle")] = 0.0, -- STINGER
	[GetHashKey("weapon_carbinerifle")] = 0.01, -- MINIGUN
	...
	[GetHashKey("weapon_carbinerifle")] = 0.7, -- MUSKET
	[GetHashKey("weapon_carbinerifle")] = 0.9, -- FLARE GUN
