        ...
        Citizen.CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(RMenu:Get('core', 'drusilla_main'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("lancer une mission de livraison", "Au moins 1 ~b~Pizza simple~s~ est requis.", {}, pInventory["Pizza simple"] ~= nil, function(Hovered, Active, Selected)
                        if Selected then
